sap.ui.define([
		...
		return BaseObject.extend("Categories.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias Categories.model.ListSelector
			 */
			 ...
			 * @return {Categories.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
