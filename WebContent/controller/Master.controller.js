/*global history */
sap.ui.define([
		"Categories/controller/BaseController",
		...
		return BaseController.extend("Categories.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("Categories.view.ViewSettingsDialog", this);
